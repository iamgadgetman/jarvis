...
import com.gadgetman.jarvis.vanilla.fake.ActionPack;
import com.gadgetman.jarvis.vanilla.fake.ActionPack.Action;
import com.gadgetman.jarvis.vanilla.fake.ActionPack.ActionType;
...
public final class FakeDriver {
    ...
    private boolean plan() {
        ...
        JarvisMod.LOG.debug("[{}] {} -> {}: {} ({} nodes)", player.getName().getString(), from, goal,
    ...
    public void tick() {
        ...
        if (follower.isStuck() || follower.hasStrayed()) {
            JarvisMod.LOG.debug("[{}] {} at {}, planning again", player.getName().getString(),

...
public final class VanillaEntity implements Entity {

    private final net.minecraft.world.entity.Entity e;

    public VanillaEntity(net.minecraft.world.entity.Entity e) {
        this.e = e;
    }
    ...
    @Override public String typeId() { return VanillaWorlds.typeId(e); }
    @Override public EntityKind kind() { return VanillaWorlds.kind(e); }
    @Override public boolean isAlive() { return e.isAlive(); }
    @Override public boolean isCreeper() { return e instanceof Creeper; }
    @Override public WorldId world() { return VanillaWorlds.id(e.level()); }
    @Override public Vec3 pos() { return VanillaWorlds.vec(e.position()); }
    @Override public Vec3 eyePos() { return VanillaWorlds.vec(e.getEyePosition()); }
    @Override public Vec3 velocity() { return VanillaWorlds.vec(e.getDeltaMovement()); }
    ...
    public Optional<Item> asItem() {
        return e instanceof ItemEntity item ? Optional.of(VanillaItems.toItem(item.getItem())) : Optional.empty();
    }
    ...
    public void setItem(Item item) {
        if (e instanceof ItemEntity drop) {
            ...
            else drop.setItem(VanillaItems.toStack(server(), item));
        }
    }
    ...
    public boolean equals(Object o) {
        return o instanceof VanillaEntity other && other.e.getUUID().equals(e.getUUID());
    }

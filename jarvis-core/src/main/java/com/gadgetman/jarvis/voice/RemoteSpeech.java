...
/**
 * Speech through an OpenAI-compatible speech server on the network, for
 * {@code voice.engine: server}. The alternative to {@link EmbeddedSpeech}
 * for anyone who wants the work off the game host.
 *
 * <p>Any server implementing {@code /v1/audio/transcriptions} and
 * {@code /v1/audio/speech} works; a {@code speaches} container serves both
 * from one process.
 *
 ...
 */
public final class RemoteSpeech implements Speech {

...
| `/jarvis confirm` | Confirm your pending dangerous action prompt (for actions you are permitted to run) | `jarvis.admin` |
| `/jarvis cancel` | Cancel your pending dangerous action prompt | `jarvis.admin` |
| `/jarvis <anything>` | Natural language — Jarvis figures it out | `jarvis.use` |

Dangerous prompts are tied to actions you are already authorized to run and are administered under `jarvis.admin`.
